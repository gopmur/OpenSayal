...
MouseClickAction
get_mouse_click_action_from_string(std::string str,
...
MouseScrollAction
get_mouse_scroll_action_from_string(std::string str,
...
Config ConfigParser::parse() const {
  ...
  config = {
		.thread = {
			.cuda = {
				.block_size_x = ConfigParser::get_or(
    ...
    .visual = {
			...
			.path_line = {
				.enable = ConfigParser::get_or(config_json,
																	...
																	false),
				.length = 						ConfigParser::get_or(config_json,
				...
				.distance = ConfigParser::get_or(config_json,
